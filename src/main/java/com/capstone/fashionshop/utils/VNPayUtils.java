...
public class VNPayUtils {
    ...
    public static String vnp_HashSecret = "CYRZSLSDARTODVXSOAOSGJMZULNPUQZI";//IJSZUKHJGTJAPZQHIBHRYQZBDRWIQGKJ
    ...
    public static String vnp_TmnCode = "LDASSMNX";//2NVBP3BW
